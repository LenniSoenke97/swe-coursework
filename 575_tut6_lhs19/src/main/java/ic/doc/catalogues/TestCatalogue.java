...
public class TestCatalogue implements Catalogue {

  private static ic.doc.catalogues.TestCatalogue instance;

  private TestCatalogue() {}

  public static synchronized ic.doc.catalogues.TestCatalogue getInstance() {
    if (instance == null) {
